...
describe ChallengeGradesController do
  ...
  # ChallengeGradesController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET show" do
    it "assigns the requested challenge_grade as @challenge_grade" do
      challenge_grade = ChallengeGrade.create! valid_attributes
      get :show, {:id => challenge_grade.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested challenge_grade as @challenge_grade" do
      challenge_grade = ChallengeGrade.create! valid_attributes
      get :edit, {:id => challenge_grade.to_param}, valid_session
      assigns(:challenge_grade).should eq(challenge_grade)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new ChallengeGrade" do
        expect {
          post :create, {:challenge_grade => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved challenge_grade as @challenge_grade" do
        ...
        post :create, {:challenge_grade => { "challenge_id" => "invalid value" }}, valid_session
        assigns(:challenge_grade).should be_a_new(ChallengeGrade)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested challenge_grade" do
        ...
        ChallengeGrade.any_instance.should_receive(:update_attributes).with({ "challenge_id" => "1" })
        put :update, {:id => challenge_grade.to_param, :challenge_grade => { "challenge_id" => "1" }}, valid_session
      end

      it "assigns the requested challenge_grade as @challenge_grade" do
        challenge_grade = ChallengeGrade.create! valid_attributes
        put :update, {:id => challenge_grade.to_param, :challenge_grade => valid_attributes}, valid_session
        assigns(:challenge_grade).should eq(challenge_grade)
      end
    ...
    describe "with invalid params" do
      it "assigns the challenge_grade as @challenge_grade" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        ChallengeGrade.any_instance.stub(:save).and_return(false)
        put :update, {:id => challenge_grade.to_param, :challenge_grade => { "challenge_id" => "invalid value" }}, valid_session
        assigns(:challenge_grade).should eq(challenge_grade)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested challenge_grade" do
      challenge_grade = ChallengeGrade.create! valid_attributes
      expect {
        delete :destroy, {:id => challenge_grade.to_param}, valid_session
      }.to change(ChallengeGrade, :count).by(-1)
    end
