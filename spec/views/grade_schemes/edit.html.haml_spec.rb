...
describe "grade_schemes/edit.html.haml" do
  before(:each) do
    @grade_scheme = assign(:grade_scheme, stub_model(GradeScheme,
      :assignment_id => "",
      :ascore => "",
      :amscore => "",
      :bpscore => "",
  ...
  it "renders the edit grade_scheme form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => grade_schemes_path(@grade_scheme), :method => "post" do
