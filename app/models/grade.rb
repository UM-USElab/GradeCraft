class Grade < ActiveRecord::Base
  ...
  attr_accessible :type, :raw_score, :final_score, :feedback, :assignment_id, :badge_id, :created_at, :updated_at, :complete, :semis, :finals, :status, :attempted, :substantial, :user, :badge_ids, :grade, :gradeable, :gradeable_id, :gradeable_type, :earned_badges_attributes, :earned, :assignment_submission_id, :badge_ids, :earned_badge_id, :gradeable_attributes, :earned_badges, :earned_badges_attributes
  ...
  scope :completion, -> lambda { where order: "assignments.due_date ASC" }, :joins => :assignment
  scope :released, -> lambda { where status: "Released" }
